...
import { TrendLinePluginPaneRenderer } from './pane-renderer';
...
export class TrendLinePluginPaneView implements IPrimitivePaneView {
	_source: TrendLinePluginDataSource;
	_p1: ViewPoint = { x: null, y: null };
	_p2: ViewPoint = { x: null, y: null };

	constructor(source: TrendLinePluginDataSource) {
		this._source = source;
	}
	...
	renderer() {
		return new TrendLinePluginPaneRenderer(
			this._p1,
			this._p2,
