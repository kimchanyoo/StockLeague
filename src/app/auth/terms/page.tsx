    ...
    <div className="container">
        <div className="termsContainer">
            ...
            <div className="termsContent">
              1. 서비스 이용약관<br/>
              - 본 서비스는 회원에게 투자 시뮬레이션 및 관련 정보를 제공합니다.<br/>
              - 회원은 타인의 정보를 도용하거나, 서비스를 부정한 목적으로 이용해서는 안 됩니다.<br/>
              - 회사는 서비스 제공을 위해 필요한 경우 이용자의 일부 정보를 수집·이용할 수 있으며, 자세한 사항은 개인정보처리방침을 따릅니다.<br/>
              - 회사는 사전 공지 없이 서비스의 일부를 수정, 중단할 수 있습니다.<br/><br/>
              2. 개인정보 수집 및 이용<br/>
              - 수집 항목: 닉네임, 이메일 주소, 투자 기록 등<br/>
              - 수집 목적: 서비스 제공, 사용자 식별, 통계 분석<br/>
              - 보유 기간: 회원 탈퇴 시 즉시 파기<br/>
            </div>
