...
public record InquiryDetailForAdminResponseDto(
        Boolean success,
        Long inquiryId,
        Long userId,
        String userNickname,
    ...
    public static InquiryDetailForAdminResponseDto from(Inquiry inquiry, InquiryAnswerDto answer) {
        return new InquiryDetailForAdminResponseDto(
                true,
                inquiry.getId(),
                inquiry.getUserId(),
                inquiry.getNickname(),
